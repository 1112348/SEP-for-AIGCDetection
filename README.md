...
We provide pretrained weights for **inference/evaluation** via Baidu Netdisk:

- **weights**: https://pan.baidu.com/s/1OAHbreVuTulwXJpu4B3dcg?pwd=xqtq  
- **Extraction code**: `xqtq`

### Run inference

1. Download the weight file and place it anywhere locally (e.g., `./weights/`).
2. Run:

```bash
python inference.py --weights /path/to/your/weights_file
